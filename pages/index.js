  ...
  return (
    ...
    >
          ...
          <section className={`${panelClass} p-5 sm:p-6`}>
            ...
            <form className="grid gap-4" onSubmit={handleRegister}>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center rounded-xl px-4 py-3 text-sm font-medium text-white shadow-sm hover:shadow"
                  style={{ backgroundColor: "#3C5768" }}
                >
                  登録してはじめる
                </button>
              </div>
                ...
                return (
                  <button
                    ...
                    className={`rounded-xl border px-3 py-2 text-sm transition-all ${
                      active
                        ? "text-white"
                        : "border-neutral-300 bg-white text-neutral-700 hover:shadow-sm"
                    }`}
                    style={active ? { backgroundColor: "#3C5768", borderColor: "#3C5768" } : {}}
                  >
                    {label}
                  </button>
                );
                ...
                <div className="space-y-7">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="rounded-xl border border-neutral-300 bg-white p-4">
                      ...
                      <div className="mt-3">
                        <button
                          className="rounded-xl px-4 py-2 text-sm font-medium text-white hover:shadow"
                          style={{ backgroundColor: "#3C5768" }}
                          onClick={() => {
                            setTab("daily");
              ...
              <section className={`${panelClass} p-5 sm:p-6`}>
                ...
                <div className="rounded-xl border border-neutral-300 bg-white p-4">
                  <div className="text-base font-medium">
                    ...
                    {nick ? `${nick} さんは` : ""}
                    {["分析型", "社交型", "直感型", "勤勉型", "創造型"][
                      seededIndex(dob + gender + place, 5)
                    ]}
                  </div>
                  <p className="mt-2 text-sm leading-7 text-neutral-700">
                    {genParagraph(dob + gender + place + "persona")}
                  </p>
                </div>
            ...
            {tab === "friends" && (
              <section className={`${panelClass} p-6 sm:p-8`}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        type="time"
                        className="mt-1 w-full rounded-lg border border-neutral-300 bg-neutral-100 p-2 text-sm"
                        value={friendForm.time}
                        onChange={(e) => setFriendForm((v) => ({ ...v, time: e.target.value }))}
                      />
                    </div>
                    <div>
                      <label className={labelClass}>性別</label>
                    ...
                    <div className="sm:col-span-2">
                      <label className={labelClass}>出生地（任意）</label>
                      <input
                        type="text"
                        className="mt-1 w-full rounded-lg border border-neutral-300 bg-neutral-100 p-2 text-sm"
                        value={friendForm.place}
                        onChange={(e) => setFriendForm((v) => ({ ...v, place: e.target.value }))}
                      />
                    </div>
                    <div className="sm:col-span-2 mt-2">
                      <button
                        type="submit"
                        className="w-full rounded-xl px-4 py-3 text-sm font-medium text-white hover:shadow"
                        style={{ backgroundColor: "#3C5768" }}
                      >
                        友達を追加
                      </button>
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  {/* 一覧 */}
                  <div className="rounded-xl border border-neutral-300 bg-white p-4">
                    <div className="mb-2 text-sm text-neutral-500">友達一覧</div>
                    {friends.length === 0 ? (
                      <div className="text-sm text-neutral-500">まだ登録がありません。</div>
                    ) : (
                      <div className="grid gap-2">
                        {friends.map((f) => (
                          <div key={f.id} className="flex items-center justify-between rounded-lg border border-neutral-300 bg-neutral-50 p-2">
                            <button
                  ...
                  <div className="rounded-xl border border-neutral-300 bg-white p-4">
                    ...
                    {!selectedFriend ? (
                      <div className="text-sm text-neutral-500">左の一覧から選択してください。</div>
                    ) : (
                      <>
      ...
      <button
        ...
        style={{ backgroundColor: "#3C5768", zIndex: 40 }}
      ...
      {editOpen && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute left-1/2 top-1/2 w-[min(92vw,560px)] -translate-x-1/2 -translate-y-1/2 transform rounded-2xl bg-white p-5 shadow-xl ring-1 ring-neutral-300">
